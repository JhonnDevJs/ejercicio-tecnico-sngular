...
export class CardPerson extends LitElement {
  ...
  render() {
    return html`
      <div id="${this.id}" class="card" @click="${this._openModal}">
      ...
      ${this.isActiveModal
        ? html` <modal-person
            ...
            isOpenModal="${this.isActiveModal}"
            .closeModal="${() => {
              this._closeModal();
            }}"
          ></modal-person>`
